    ...
    <div class="px-40 py-9 w-full">
      ...
      <form action="" method="post" class="mt-8">
        <dl>
          ...
          <dd><input class="w-full p-2 bg-slate-200 text-sm mt-2" type="email" name="" placeholder="メールアドレスを入力" required /></dd>
          <dt class="mt-6"><label>パスワード</label></dt>
          <dd class="mt-2"><input class="w-full p-2 bg-slate-200 text-sm" type="text" name="" placeholder="パスワードを入力" /></dd>
        </dl>
