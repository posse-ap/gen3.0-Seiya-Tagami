  ...
  <main>
    <div class="flex">
      ...
      <div class="px-14 py-9 max-w-5xl w-full">
        <h2 class="text-4xl font-bold">問題更新</h2>
        <form action="../../services/update_question.php" method="post" enctype="multipart/form-data" class="mt-8">
          <dl>
            <dt><label>問題文</label></dt>
            <dd><input class="w-full p-2 bg-slate-200 text-sm mt-2" type="text" name="question" value="" required /></dd>
            <dt class="mt-6"><label class="">選択肢</label></dt>
            <dd class="flex flex-col gap-2 mt-2">
              <input class="w-full p-2 bg-slate-200 text-sm" type="text" name="choice[]" value="" placeholder="選択肢１" required />
              <input class="w-full p-2 bg-slate-200 text-sm" type="text" name="choice[]" value="" placeholder="選択肢２" required />
              <input class="w-full p-2 bg-slate-200 text-sm" type="text" name="choice[]" value="" placeholder="選択肢３" required />
            </dd>
            ...
            <dt class="mt-6">補足</dt>
            <dd class="mt-2"><input class="w-full p-2 bg-slate-200 text-sm" type="text" name="supplement" value="" placeholder="補足テキスト"/></dd>
            <dd class="mt-2"><input class="w-full p-2 bg-slate-200 text-sm" type="text" name="supplement_url" value="" placeholder="補足URL"/></dd>
          </dl>
